      ...
      <div class="modal-body" v-if="contact">
            ...
            >
              <div class="conversation-header">
                <div class="conversation-meta">
                  ...
                  <span class="conversation-time">{{ formatRelativeTime(conversation.last_activity_at) }}</span>
                </div>
                <div v-if="conversation.inbox" class="inbox-badge">
              ...
              <div class="conversation-footer">
                ...
                <span v-if="conversation.assignee" class="assignee-info">
                  Atribuído a: {{ conversation.assignee.name }}
                </span>
              </div>
            </div>
          </div>
        ...
        <div v-else-if="activeTab === 'notes'" class="tab-content">
          <div class="notes-header">
            <button class="btn-primary" @click="showAddNote = true">
              <svg class="icon-small" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                ...
                <div class="activity-content">
                  <div class="activity-title">
                    ...
                    <span class="activity-time">{{ formatRelativeTime(conversation.last_activity_at) }}</span>
                  </div>
                  <div class="activity-description">
                    {{ conversation.inbox?.name || 'Canal desconhecido' }}
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    async saveNote() {
      ...
      try {
        await ContactNotesAPI.create(this.contact.id, this.newNoteContent.trim())
        this.newNoteContent = ''
    ...
    openConversation(conversationId) {
      const accountId = this.currentAccount?.id
      if (accountId) {
        window.open(`/app/accounts/${accountId}/conversations/${conversationId}`, '_blank')
      }
    },
